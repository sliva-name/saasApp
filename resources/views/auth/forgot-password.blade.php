<x-guest-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        ...
        <div class="w-full sm:max-w-4xl mt-6 flex flex-col lg:flex-row gap-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-10">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            Введите ваш email для получения ссылки сброса
                        </p>
                    </div>
            ...
            <!-- Instructions -->
            <div class="lg:w-80">
                <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 h-fit">
                    <div class="flex">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-sm text-blue-700 dark:text-blue-300 space-y-1">
                                <p>1. Введите email, указанный при регистрации</p>
                                <p>2. Мы отправим вам письмо со ссылкой для сброса</p>
                                <p>3. Перейдите по ссылке и создайте новый пароль</p>
                            </div>
                        </div>
                    </div>
                </div>
