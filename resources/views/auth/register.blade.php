                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="terms" class="text-gray-700 dark:text-gray-300">
                                    Я согласен с 
                                    <a href="#" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 font-medium">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center">
                            ...
                            <p class="ml-3 text-sm text-gray-700 dark:text-gray-300">
                                Создавайте неограниченное количество магазинов
                            </p>
                        </div>
                        <div class="flex items-center">
                            ...
                            <p class="ml-3 text-sm text-gray-700 dark:text-gray-300">
                                Полный контроль над дизайном и настройками
                            </p>
                        </div>
                        <div class="flex items-center">
