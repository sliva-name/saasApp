<x-guest-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        ...
        <div class="w-full sm:max-w-4xl mt-6 flex flex-col lg:flex-row gap-8">
            <!-- Verify Email Form -->
            <div class="flex-1">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-10">
                    <!-- Header -->
                    <div class="text-center mb-8">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            Спасибо за регистрацию! Подтвердите ваш email для продолжения
                        </p>
                    </div>
                    ...
                    <div class="text-center mb-6">
                        <div class="w-20 h-20 mx-auto mb-4 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            Нажмите на ссылку в письме, чтобы подтвердить ваш аккаунт.
                        </p>
                    </div>
                        ...
                        <form method="POST" action="{{ route('verification.send') }}">
                            ...
                            <button type="submit" 
                                ...
                                <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                    <i class="fas fa-paper-plane text-indigo-300 group-hover:text-indigo-200 transition-colors"></i>
                                </span>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-sm text-blue-700 dark:text-blue-300 space-y-1">
                                <p>• Проверьте папку "Спам" или "Промо"</p>
                                <p>• Убедитесь, что email указан правильно</p>
                                <p>• Нажмите "Отправить письмо повторно"</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-sm text-yellow-700 dark:text-yellow-300 space-y-1">
                                <p>• Никогда не переходите по ссылкам из подозрительных писем</p>
                                <p>• Проверяйте адрес отправителя</p>
                                <p>• Используйте надежные пароли</p>
                            </div>
                        </div>
                    </div>
                </div>
