                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-10">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            Это защищенная область приложения. Подтвердите пароль для продолжения.
                        </p>
                    </div>
                        ...
                        <div>
                            <button type="submit" 
                                ...
                                <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                    <i class="fas fa-check text-indigo-300 group-hover:text-indigo-200 transition-colors"></i>
                                </span>
                                Подтвердить
                            </button>
                        </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm text-blue-700 dark:text-blue-300">
                                Это действие требует дополнительной проверки безопасности. 
                                Введите пароль для подтверждения вашей личности.
                            </p>
                        </div>
                    </div>
                </div>
